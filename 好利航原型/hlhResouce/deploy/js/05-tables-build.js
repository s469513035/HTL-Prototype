...
addPrototypeTable('fcl-release','放仓作业','放仓单号|订舱单号|船司|订舱号|柜型柜量|放仓时间|放仓附件|处理人|状态|操作',['待放仓','已放仓','需跟进'],[
    ['FRL-20260613001','FBK-20260613001','MAERSK','MAEU985633','40HQ×1','2026-06-13 11:00','release_001.pdf','刘订舱','待放仓'],
    ['FRL-20260612002','FBK-20260612002','COSCO','COSU778812','20GP×2','2026-06-12 16:10','release_002.pdf','赵订舱','已放仓']
]);
addPrototypeTable('fcl-truck','拖车安排','拖车单号|订舱单号|提柜地点|装柜地点|还柜地点|拖车公司|预约时间|司机电话|状态|操作',['待安排','已安排','已完成','异常'],[
...
addPrototypeTable('fcl-load','进仓装柜','装柜单号|订舱单号|柜号|封号|装柜地点|装柜件数|毛重(KG)|装柜时间|操作人|状态|操作',['待装柜','装柜中','已装柜','异常'],[
...
addPrototypeTable('fcl-si-bl','补料与提单','补料单号|订舱单号|提单号|客户实单|提单费用状态|MBL/HBL|收货人|通知人|补料截止|草稿件状态|客户确认状态|操作',['待补料','已补料','草稿确认中','已确认'],[
...
addPrototypeTable('fcl-customs','报关申报','报关单号|订舱单号|柜号|报关方式|报关行|申报时间|放行时间|资料状态|报关状态|操作',['待申报','已申报','已放行','异常'],[
...
addPrototypeTable('fcl-sailing-track','开船与轨迹','轨迹单号|订舱单号|船名航次|ETD|ATD|ETA|当前节点|异常预警|更新时间|状态|操作',['未开船','已开船','在途','已到港','异常'],[
...
addPrototypeTable('fcl-commission','业绩与提成','提成单号|订舱单号|业务员|客户名称|毛利|提成比例|提成金额|币别|核算月份|状态|操作',['待核算','已核算','已发放'],[
...
addPrototypeTable('fcl-exception','异常处理','异常单号|关联单号|异常类型|异常环节|异常描述|当前处理人|处理时限|创建时间|状态|操作',['待处理','处理中','已关闭'],[
    ['FEX-20260613001','FBK-20260613001','订舱失败','订舱作业','船司系统返回舱位不足','刘订舱','2026-06-13 18:00','2026-06-13 11:30','处理中'],
...
addPrototypeTable('fcl-sla-kpi','SLA与KPI','指标编号|指标名称|适用环节|目标值|当前值|责任角色|统计周期|预警状态|操作',['正常','预警','超时'],[
    ['KPI-001','订舱及时率','订舱作业','95%','92%','订舱员','本月','预警'],
