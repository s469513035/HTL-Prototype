...
function actionConfig(action,id,rowData){
    ...
    if(action==='bookingReceipt')return {title:'登记订舱回执 - '+name,fields:[{label:'订舱回执号',required:true},{label:'协议号'},{label:'船名航次'},{label:'回执时间',type:'datetime-local',required:true},{label:'回执附件',type:'attachment',span:'md:col-span-2'},{label:'回执说明',type:'textarea',span:'md:col-span-2',value:'登记后订舱状态转「已订舱」，主状态同步推进。'}],confirm:'确认登记'};
