...
addPrototypeTable('fcl-agent-cost','代理成本明细',
    ...
    /* 散货拼箱：Job 与委托单一对一，成本要摊到委托单底下的每票散货订单 */
    ['FAC-20260609005','AGB-20260615003','FBK-20260609006','MAERSK','目的港THC','THC','USD','2900','3000','100','3.45%','按体积','MSK-THC-260615','','张财务','2026-06-14 16:30','散货拼箱柜，摊到 3 票散货订单','已分摊']
],[
    {label:'流水号',type:'text'},
