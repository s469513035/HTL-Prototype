...
var ROLE_MENUS={
    'role-admin':['workspace','customer-mgmt','waybill-mgmt','fcl','warehouse','overseas-wh','cs','approval','finance','biz-config','perm'],
...
var TERMINAL_MENUS={
    'oms':['oms-client'],
    'tms':['workspace','customer-mgmt','waybill-mgmt','fcl','warehouse','overseas-wh','cs','approval','finance','biz-config','perm'],
    'pda':[]
};
