 ...
 * 我方账户名称由账户号带出，认领时间/认领人要等认领动作发生后才有 */
...
addPrototypeTable('fin-cust-account','客户账户',
    '客户代码|客户名称|所属业务|所属客服|所属操作|所属公司|账户币别|余额|信用额度|超额是否锁定客户|操作',
    [],[
    ['C10001','深圳市华运达国际货运','张三','陈七','刘操作','深圳总部','CNY','128,500.00','200,000.00','否'],
    ['C10002','广州远洋进出口贸易','李四','周八','王操作','广州业务分部','USD','-12,400.00','50,000.00','是'],
    ['C10003','东莞市鑫海物流','王五','吴九','刘操作','深圳总部','CNY','86,200.00','150,000.00','否'],
    ['C10004','上海锦程国际贸易','赵六','陈七','李操作','义乌分部','USD','0.00','80,000.00','否'],
    ['C10005','佛山恒通货运代理','张三','周八','王操作','广州业务分部','CNY','-5,600.00','60,000.00','是'],
    ['C10006','星星玩具电商','李四','吴九','李操作','宁波分部','EUR','23,100.00','40,000.00','否']
],[
