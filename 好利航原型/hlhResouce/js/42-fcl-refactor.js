 ...
 * 主线收敛：委托订单 FEO（原销售指示）→ 订仓单 FBK（全链路主档）→ 各作业单
 *
...
addPrototypeTable('fcl-booking','订仓作业',
    '订仓单号|委托订单号|仓位类型|客户名称|船司|航线|起运港|目的港|柜型柜量|船名航次|ETD|订仓回执号|约号|截补料时间|订仓方式|是否危险品|UN编号|危险类别|包装类别|危险品申报人|关联仓位编号|订仓员|备注|订仓状态|操作',
    ['待订仓','已订仓','订仓失败','取消订仓'],[
    ['FBK-20260613001','FEO-20260613001','实单订仓','深圳市华运达国际货运','MAERSK','西非线','深圳盐田','拉各斯','40HQ×1','MAERSK LAGOS 026W','2026-06-20','','MSK-CN-2026-8891','2026-06-17 12:00','EDI','否','','','','','FSL-20260613001','刘订仓','客户要求本航次务必装出','待订仓'],
    ['FBK-20260612002','FEO-20260612002','实单订仓','广州远洋进出口贸易','COSCO','西非线','广州南沙','达喀尔','20GP×2','COSCO AFRICA 118W','2026-06-22','COSU778812','COS-CN-2026-4412','2026-06-18 18:00','官网','否','','','','','FSL-20260612002','赵订仓','船司已确认舱位','已订仓'],
    ['FBK-20260611003','FEO-20260611003','实单订仓','东莞市鑫海物流','CMA CGM','地中海线','上海洋山','阿比让','40HQ×1','CMA MARSEILLE 09W','2026-06-25','','CMA-CN-2026-3320','2026-06-21 12:00','EDI','是','UN3480','9类 锂电池','PI965','李申报','FSL-20260611003','刘订仓','危险品，结单时间早于普货48小时','待订仓'],
...
addPrototypeTable('fcl-sales-instruction','委托订单管理',
    '委托订单号|委托类型|来源|客户名称|托书编号|托书附件|船司|柜型柜量|起运港|目的港|预计开船日|销售运费|预估成本|预估毛利|业务员|提交时间|审核人|审核时间|生成订仓单号|状态|操作',
    ['待审核','已审核','已驳回','已转订仓','已取消'],[
    ...
    ['FEO-20260612002','实单','询盘转化','广州远洋进出口贸易','BOOK-002','托书_远洋_0612.pdf;装箱单_0612.xlsx','COSCO','20GP×2','广州南沙','达喀尔','2026-06-22','USD 5,600','USD 5,180','USD 420','李四','2026-06-12 16:00','商务主管','2026-06-12 17:10','FBK-20260612002','已转订仓'],
    ['FEO-20260611003','实单','OMS客户自助下单','东莞市鑫海物流','BOOK-003','托书_鑫海_0611.pdf','CMA CGM','40HQ×1','上海洋山','阿比让','2026-06-25','USD 6,200','USD 5,600','USD 600','王五','2026-06-11 09:20','商务主管','2026-06-11 11:00','FBK-20260611003','已转订仓'],
    ...
    {label:'状态',type:'select',options:['待审核','已审核','已驳回','已转订仓','已取消']}
]);
/* 委托订单号含「单号」→ 引擎按 isCode 渲染为只读自动生成；来源由系统按录入渠道自动赋值，不在弹窗显示 */
TC['fcl-sales-instruction'].modalExcludedFields=['来源','预估毛利','提交时间','审核人','审核时间','生成订仓单号','状态'];
...
addPrototypeTable('fcl-order','整柜业务总览',
    ...
    ['FBK-20260613001','FEO-20260613001','深圳市华运达国际货运','张三','MAERSK','西非线','40HQ×1','MAERSK LAGOS 026W','2026-06-20','','2026-07-18','待订仓','●●●◐○○○○○○○○○○○','刘订仓','订仓窗口 2026-06-17 18:00 截止','USD 4,500','USD 4,120','USD 380'],
    ...
    ['FBK-20260610005','FEO-20260610005','广州远洋进出口贸易','李四','CMA CGM','西非线','20GP×1','CMA ABIDJAN 11W','2026-06-18','','2026-07-16','异常挂起','●●●●✖○○○○○○○○○○','刘订仓','订仓失败：船司舱位不足（FEX-20260613001）','USD 2,680','USD 2,580','USD 100']
],[
    {label:'票单号',type:'text'},
    {label:'委托订单号',type:'text'},
    {label:'客户名称',type:'select',options:FCL_CUSTOMER_OPTIONS},
...
{no:'③',name:'委托订单录入',sop:'SOP-FCL-03',stage:'sales',role:'业务员（主导）、商务（审核）',
 ...
 output:'委托订单 FEO；审核通过后自动生成订仓单 FBK；状态 待订仓',
...
{group:'② 询盘与委托订单',hint:'业务员的完整工作面',items:[
    ...
    ['委托订单管理','fcl-sales-instruction','fcl','销售指示即客户委托单，预录单与实单统一在此录入，审核通过后生成订仓单']]},
