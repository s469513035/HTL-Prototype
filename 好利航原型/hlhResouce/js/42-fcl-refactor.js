...
addPrototypeTable('fcl-est-cost','预估成本明细',
    ...
    ['FEC-20260613003','FBK-20260613001','报关费','深圳报关行','CNY','350','报价带出','','张财务','2026-06-13 15:26','草稿'],
...
/* Job No 和供应商是这条成本挂在谁头上、找谁付钱，缺了后面对不上账，设为必填
 *（全局正则不认这两个词，必须显式覆写） */
TC['fcl-est-cost'].requiredOverrides={'Job No':true,'供应商':true};
 ...
 * 这一页只做两件事：看成本明细、把 Job 成本手工分摊到委托单（散拼再往下摊到订单）。
...
addPrototypeTable('fcl-agent-cost','代理成本明细',
    ...
    /* 散拼：Job 与委托单一对一，成本要摊到委托单底下的每票散货订单 */
    ['FAC-20260609005','AGB-20260615003','FBK-20260609006','MAERSK','目的港THC','THC','USD','2900','3000','100','3.45%','按体积','MSK-THC-260615','','张财务','2026-06-14 16:30','散拼柜，摊到 3 票散货订单','已分摊']
],[
    {label:'流水号',type:'text'},
...
addPrototypeTable('fcl-ap-bill','付款单管理',
    '付款单号|服务商|账单周期|涉及Job数|费用行数|币别|应付金额|已付金额|待付金额|账期|付款用途|期望付款时间|到期日|收款账号|申请人|申请时间|审批人|审批时间|付款方式|付款时间|付款水单|账单状态|操作',
    ['待审批','审批驳回','待付款','部分付款','已付清','已作废'],[
    ['FAP-20260613001','MAERSK','2026-06','2','3','USD','8320','0','8320','月结30天','海运费及附加费','2026-07-10','2026-07-13','MAERSK CHINA / 汇丰 808-***-221','张财务','2026-06-16 10:40','','','','','','待审批'],
    ['FAP-20260612002','COSCO','2026-06','1','1','USD','5180','5180','0','票结','海运费','2026-06-18','2026-06-20','中远海运 / 中行 4563-***-118','张财务','2026-06-15 14:10','财务主管','2026-06-15 17:00','电汇','2026-06-18 15:30','水单_COSCO_0618.pdf','已付清'],
    ['FAP-20260610003','鹏程拖车','2026-06','3','5','CNY','5400','2000','3400','月结15天','拖车费','2026-06-28','2026-06-30','深圳鹏程运输 / 招行 6225-***-905','李操作','2026-06-10 09:20','财务主管','2026-06-10 15:30','电汇','2026-06-20 11:00','水单_鹏程_0620.pdf','部分付款'],
    ['FAP-20260605004','深圳报关行','2026-05','4','4','CNY','1680','1680','0','月结30天','报关费','2026-06-04','2026-06-05','深圳市中远报关 / 工行 4000-***-772','李操作','2026-06-02 08:50','财务主管','2026-06-03 11:00','电汇','2026-06-04 16:20','水单_报关行_0604.pdf','已付清'],
    /* 同服务商同币别两张「待付款」：用来演示批量核销（MAERSK 名下还有 USD 流水余额） */
    ['FAP-20260614005','MAERSK','2026-06','1','2','USD','4200','0','4200','月结30天','海运费','2026-07-12','2026-07-15','MAERSK CHINA / 汇丰 808-***-221','张财务','2026-06-17 09:10','财务主管','2026-06-17 15:20','','','','待付款'],
    ['FAP-20260614006','MAERSK','2026-06','1','1','USD','1200','0','1200','月结30天','目的港THC','2026-07-12','2026-07-15','MAERSK CHINA / 汇丰 808-***-221','张财务','2026-06-17 09:15','财务主管','2026-06-17 15:22','','','','待付款']
],[
    {label:'付款单号',type:'text'},
    {label:'服务商',type:'select',options:FCL_AGENT_OPTIONS},
    ...
    {label:'到期日',type:'date'},
    {label:'账单状态',type:'select',options:['待审批','审批驳回','待付款','部分付款','已付清','已作废']}
]);
TC['fcl-ap-bill'].modalExcludedFields=['涉及Job数','费用行数','已付金额','待付金额',
    '申请人','申请时间','审批人','审批时间','付款方式','付款时间','付款水单','账单状态'];
 ...
 * 收款核销时冲这里的未收金额。 */
/* 费用科目：取代原来的「费用名称 + 费用类别」两列 —— 录的时候本来就是一个科目，
 * 拆成两列只会让人在「海运费/海运费」这种重复上浪费一次选择。 */
var FCL_FEE_ACCOUNTS=['海运费','THC','文件费','燃油附加费','旺季附加费','港杂费',
    '拖车费','报关费','单证费','仓储费','保险费','改单费','其他'];
/* 结算周期口径与客户档案一致（录入时按委托单的客户带出，不手填） */
var FCL_SETTLE_TERMS=['出货票结','出货月结','签收月结'];
addPrototypeTable('fcl-ar-fee','应收费用明细',
    '流水号|委托单号|客户名称|业务员|费用科目|币别|应收金额|已收金额|未收金额|结算周期|费用确认状态|操作',
    ['待确认','已确认','部分收款','已结清','已作废'],[
    ['FAR-20260613001','FEO-20260613001','深圳市华运达国际货运','张三','海运费','USD','4500','0','4500','出货月结','待确认'],
    ['FAR-20260613002','FEO-20260613001','深圳市华运达国际货运','张三','拖车费','CNY','2000','0','2000','出货月结','已确认'],
    ['FAR-20260612003','FEO-20260612002','广州远洋进出口贸易','李四','海运费','USD','5600','5600','0','出货票结','已结清'],
    ['FAR-20260612004','FEO-20260612002','广州远洋进出口贸易','李四','报关费','CNY','400','200','200','出货票结','部分收款'],
    ['FAR-20260610005','FEO-20260610005','','赵六','海运费','USD','3200','0','3200','出货月结','已作废'],
    /* 委托客户是自己人（广州分公司拼的柜）：这条整柜海运费的三个金额
     * 都是底下那几票散货应收统计上来的，点「查看」能看到拆分 */
    ['FAR-20260609006','FEO-20260609007','广州分公司','王五','海运费','USD','9600','3600','6000','出货月结','部分收款']
],[
    {label:'流水号',type:'text'},
    {label:'委托单号',type:'text'},
    {label:'客户名称',type:'select',options:FCL_CUSTOMER_OPTIONS},
    {label:'业务员',type:'select',options:FCL_SALES_OPTIONS},
    {label:'费用科目',type:'select',options:FCL_FEE_ACCOUNTS},
    {label:'币别',type:'select',options:FCL_CURRENCY_OPTIONS},
    {label:'结算周期',type:'select',options:FCL_SETTLE_TERMS},
...
TC['fcl-ar-fee'].fieldOptions={
    ...
    '费用科目':FCL_FEE_ACCOUNTS,'币别':FCL_CURRENCY_OPTIONS,
    '结算周期':FCL_SETTLE_TERMS
};
 ...
 * 没法给一个有意义的币种。 */
/* 锁账：月结关账后这张委托单该币别的应收就冻住，不许再新增费用 / 核销 / 反核销。
 * 「锁账状态」必须排在「收款状态」后面 —— 引擎认状态列用的是 h.includes('状态') 首个命中，
 * 放前面会把状态页签和状态徽标抢过去。 */
addPrototypeTable('fcl-ar-receipt','应收收款管理',
    '委托单号|客户名称|业务员|币别|应收总金额|已核销金额|未核销金额|关联Job|创建时间|备注|收款状态|锁账状态|锁账人|锁账时间|操作',
    ['待核销','部分核销','全部核销'],[
    ['FEO-20260613001','深圳市华运达国际货运','张三','USD','4500','0','4500','FBK-20260613001','2026-06-13 09:12','','待核销','未锁账','',''],
    ['FEO-20260613001','深圳市华运达国际货运','张三','CNY','2000','0','2000','FBK-20260613001','2026-06-13 09:12','','待核销','未锁账','',''],
    ['FEO-20260612002','广州远洋进出口贸易','李四','USD','5600','5600','0','FBK-20260612002','2026-06-12 14:05','5 月账期已关账','全部核销','已锁账','财务-陈敏','2026-07-01 10:00'],
    ['FEO-20260612002','广州远洋进出口贸易','李四','CNY','400','200','200','FBK-20260612002','2026-06-12 14:05','客户先付一半报关费','部分核销','未锁账','',''],
    ['FEO-20260609007','广州分公司','王五','USD','9600','3600','6000','FBK-20260609006','2026-06-09 16:40','自拼柜，费用按散货订单拆','部分核销','未锁账','','']
],[
    /* 创建时间排在最前：财务日常是先框一个账期区间，再往下筛客户与单号 */
    ...
    {label:'锁账状态',type:'select',options:['未锁账','已锁账']}
]);
TC['fcl-ar-receipt'].modalExcludedFields=['已核销金额','未核销金额','收款状态','创建时间','锁账状态','锁账人','锁账时间'];
/* 已有真实的创建时间列，不用引擎再补那六个审计列 ——
 * noExpand 的表拿不到审计列的值，补出来只是六个空列。 */
TC['fcl-ar-receipt'].noAutoAudit=true;
...
var FCL_RECON_TOLERANCE={rate:5,amount:50};
...
function openAgentCostReconcile(id){
    ...
    var rows=fclFinRows(id),done=0,diff=0,noData=0,locked=0;
    ...
    idxs.forEach(function(i){
        ...
        var d=+(act-est).toFixed(2);
        var rate=est?(d/est*100):(d?100:0);
        /* 差异率和差异金额都在容差内才算一致 —— 只看比例会放过大额小比例的差错 */
    ...
    if(!done){
        showToast(locked?tr('所选行已生成应付账单，不能再对账'):
            (noData?tr('所选行缺预估或实际金额，无法对账'):tr('所选行已确认，无需重复对账')));
        return;
    }
    fclFinRefresh(id);
    var msg=tr('已对账')+' '+done+' '+tr('条')+'，'+tr('其中')+' '+diff+' '+tr('条超出容差')+
        '（±'+FCL_RECON_TOLERANCE.rate+'% / ±'+FCL_RECON_TOLERANCE.amount+'）';
    if(noData)msg+='，'+noData+' '+tr('条缺金额已跳过');
    if(locked)msg+='，'+locked+' '+tr('条已生成应付已跳过');
    showToast(msg);
}
/* ===== 代理实际成本 · 代账账单导入 =====
...
/* 手工分摊已重写为「Job 成本 → 委托单 →（散拼再往下）散货订单」，见 js/45-fcl-agent-cost.js */
...
addPrototypeTable('fcl-sales-instruction','委托订单管理',
    ...
    /* 广州分公司自拼的散货柜：委托方是自己人，应收挂它头上，底下按散货订单拆 */
    ['FEO-20260609007','实单','业务员录入','广州分公司','BOOK-007','托书_广州分公司_0609.pdf','MAERSK','40HQ×1','广州南沙','拉各斯','2026-06-16','USD 9,600','USD 8,800','USD 800','王五','2026-06-09 09:20','2026-06-09 10:40','商务主管','2026-06-09 14:00','FBK-20260609006','已审核']
],[
    {label:'委托订单号',type:'text'},
