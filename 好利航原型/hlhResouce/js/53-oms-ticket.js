 ...
 *   - 客户只能 新建 / 追问（回复），不能 处理 —— 挂起/解决/关闭是客服的事；
...
var _OMS_TICKET_STATUSES=['待处理','处理中','已解决','已关闭'];
...
addPrototypeTable('oms-ticket','服务工单',
    ...
    ['OT20260908002','9/6 离港的柜子到哪了','催件','WB-20260906006','2','已解决','2026-09-09 11:30','2026-09-08 09:20'],
    ['OT20260905003','账单 BILL-20260901 仓储费有异议','费用争议','WB-20260822012','4','待处理','2026-09-12 14:15','2026-09-05 16:00'],
    ['OT20260902004','清关需要准备什么资料','清关咨询','WB-20260830009','3','已解决','2026-09-04 10:45','2026-09-02 11:30'],
